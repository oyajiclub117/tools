...
Private Sub proc_worksheet( _
	...
	Set objRange = p_objWks.Cells.Find("ìdòb")
	Do While objRange
		...
		strCsvData = _
			...
			"""" & g_strBookName & """" & "," & _
			"""" & p_objWks.Name & """" & "," & _
			"L" & objRange.Row & "-" & "C" & objRange.Column
		createCsvFile_Data strCsvData
		Set objRange = p_objWks.Cells.FindNext()
	Loop

...
Private Sub proc_worksheet( _
	...
	p_objWks.Cells(8, "Z") = "ëSäp/îºäp"
	
	p_objWks.Range("Z9:AA" & lngLastRow).Merge True
	...
	For i = SHEET_START_ROW + 1 To lngLastRow
		...
		If .Cells(i, "T") = "CHAR" _
		Or .Cells(i, "T") = "NUMBER" _
		Or .Cells(i, "T") = "VARCHAR2" Then
			.Cells(i, "Z") = "îºäp"
		ElseIf .Cells(i, "T") = "TIMESTAMP" _
		Or .Cells(i, "Z") = "DATE" Then
			.Cells(i, "X") = 6
			.Cells(i, "Z") = "îºäp"
		End If

...
Private Sub proc_worksheet( _
	...
	lngLastRow = p_objWks.Range("Y" & MAX_ROWS).End(xlUp).Row
	...
	strCsvData = _
		g_lngIdData & "," & _
		"""" & p_objWks.Application.ActiveWorkbook.Name & ":" & "DBセット(追求講座数):"
	For i = 6 To lngLastRow
	If InStr(p_objWks.Cells(i, "Y"), "追求講座数") Then
		g_lngIdData = g_lngIdData & _
		"R" & p_objWks.Cells(i, "Y").Row & _
		"C" & p_objWks.Cells(i, "Y").Column & _
		":" & p_objWks.Cells(i, "Y")
	End If
	Next
...
'--	Msgbox "script execute successfully", vbInformation, "処理完了"

...
Private Sub proc_workbook( _
	...
	For Each objWks In p_objWkb.Worksheets
		If InStr(objWks.Name, "ÉhÉÅÉCÉìíËã`èë") Then
...
Private Sub proc_worksheet( _
	...
	lngLastRow = p_objWks.Range("A8").End(xlDown).Row
	...
	For i = 9 To lngLastRow
		...
		strCsvData = _
			g_lngIdData & "," & _
			"""" & p_objWks.Cells(i, "A") & """," & _
			"""" & p_objWks.Cells(i, "H") & """," & _
			"""" & p_objWks.Cells(i, "I") & """," & _
			"""" & p_objWks.Cells(i, "J") & """," & _
			"""" & p_objWks.Cells(i, "K") & """," & _
			"""" & p_objWks.Cells(i, "L") & """," & _
			"""" & p_objWks.Cells(i, "M") & """," & _
			"""" & p_objWks.Cells(i, "N") & """," & _
			"""" & p_objWks.Cells(i, "O") & """"
